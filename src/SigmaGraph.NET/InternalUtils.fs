...
module InternalUtils =
    ...
    let getSourceCodeJS () =
        ...
        {
            Sigma = readFromManifestResource "SigmaGraph.NET.sigma.min.js";
            Graphology = readFromManifestResource "SigmaGraph.NET.graphology.umd.min.js";
            GraphologyLib = readFromManifestResource "SigmaGraph.NET.graphology-library.min.js"
        }
    ...
    let getNugetPathJS () =
        ...
        {
            Sigma = $"{home}/.nuget/packages/SigmaGraph.NET/{Globals.NUGET_VERSION}/content/sigma.min.js"
            Graphology = $"{home}/.nuget/packages/SigmaGraph.NET/{Globals.NUGET_VERSION}/content/graphology.umd.min.js"
            GraphologyLib = $"{home}/.nuget/packages/SigmaGraph.NET/{Globals.NUGET_VERSION}/content/graphology-library.min.js" ;
        }
